"""
Django settings for bsss_48695 project.
...
WSGI_APPLICATION = 'bsss_48695.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "bsss Support <support@bsss-48695.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bsss_48695 API",
    "DESCRIPTION": "API documentation for bsss_48695 App",
    "VERSION": "v1",
}
